...
#define OQS_KEM_CURVEID(nid) \
  ...
  (nid == NID_sntrup761 ? 0x0212 : \
  (nid == NID_nttru ? 0x0213 : \
  (nid == NID_nttruref ? 0x0214 : \
  (nid == NID_ctruarm ? 0x0215 : \
  (nid == NID_ctruref ? 0x0216 : \
  0 \
  ))))))))))))))))))))
...
#define OQS_KEM_HYBRID_CURVEID(nid) \
    ...
    (nid == NID_p256_sntrup761 ? 0x2F12 : \
    (nid == NID_p384_nttru ? 0x2F13 : \
    (nid == NID_p384_nttruref ? 0x2F14 : \
    (nid == NID_p384_ctruarm ? 0x2F15 : \
    (nid == NID_p384_ctruref ? 0x2F16 : \
  0 \
  ))))))))))))))))))))
...
#define OQS_KEM_NID(curveID) \
  ...
  (curveID == 0x0212 || curveID == 0x2F12 ? NID_sntrup761 : \
  (curveID == 0x0213 || curveID == 0x2F13 ? NID_nttru : \
  (curveID == 0x0214 || curveID == 0x2F14 ? NID_nttruref : \
  (curveID == 0x0215 || curveID == 0x2F15 ? NID_ctruarm : \
  (curveID == 0x0216 || curveID == 0x2F16 ? NID_ctruref : \
  0 \
  ))))))))))))))))))))
...
#define OQS_HYBRID_KEM_NID(curveID) \
    ...
    (curveID == 0x2F12 ? NID_p256_sntrup761 : \
    (curveID == 0x2F13 ? NID_p384_nttru : \
    (curveID == 0x2F14 ? NID_p384_nttruref : \
    (curveID == 0x2F15 ? NID_p384_ctruarm : \
    (curveID == 0x2F16 ? NID_p384_ctruref : \
  0 \
  ))))))))))))))))))))
...
#define OQS_ALG_NAME(nid) \
  ...
  (nid == NID_nttru ? OQS_KEM_alg_nttru : \
  (nid == NID_nttruref ? OQS_KEM_alg_nttruref_768 : \
  (nid == NID_ctruarm ? OQS_KEM_alg_ctruarm : \
  (nid == NID_ctruref ? OQS_KEM_alg_ctruref : \
  0 \
  ))))))))))))))))))))
