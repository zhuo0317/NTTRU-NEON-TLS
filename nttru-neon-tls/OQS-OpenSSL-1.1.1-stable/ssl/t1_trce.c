...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_nttru), "nttru"},
    {OQS_KEM_CURVEID(NID_nttruref), "nttruref"},
    {OQS_KEM_CURVEID(NID_ctruarm), "ctruarm"},
    {OQS_KEM_CURVEID(NID_ctruref), "ctruref"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_p384_nttru), "p384 - nttru hybrid"},
    {OQS_KEM_CURVEID(NID_p384_nttruref), "p384 - nttruref hybrid"},
    {OQS_KEM_CURVEID(NID_p384_ctruarm), "p384 - ctruarm hybrid"},
    {OQS_KEM_CURVEID(NID_p384_ctruref), "p384 - ctruref hybrid"},
