...
///// OQS_TEMPLATE_FRAGMENT_ASSIGN_SIG_ALG_START
    ...
    case NID_nttru:
    case NID_p384_nttru:
      return OQS_KEM_alg_nttru;
    case NID_nttruref:
    case NID_p384_nttruref:
      return OQS_KEM_alg_nttruref_768;
    case NID_ctruarm:
    case NID_p384_ctruarm:
      return OQS_KEM_alg_ctruarm;
    case NID_ctruref:
    case NID_p384_ctruref:
      return OQS_KEM_alg_ctruref;
