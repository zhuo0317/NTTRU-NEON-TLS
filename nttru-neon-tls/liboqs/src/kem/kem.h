...
/** Algorithm identifier for NTTRU KEM (Round-4). */
#define OQS_KEM_alg_nttru "NTTRU"
/** Algorithm identifier for NTTRU-768 KEM (Round-4). */
#define OQS_KEM_alg_nttruref_768 "NTTRUREF"
/** Algorithm identifier for CTRU KEM (Round-4). */
#define OQS_KEM_alg_ctruarm "CTRUARM"
/** Algorithm identifier for CTRUREF KEM (Round-4). */
#define OQS_KEM_alg_ctruref "CTRUREF"
...
#endif /* OQS_ENABLE_KEM_NTTRU */

#ifdef OQS_ENABLE_KEM_NTTRUREF
#include <oqs/kem_nttruref.h>
#endif /* OQS_ENABLE_KEM_NTTRUREF */

#ifdef OQS_ENABLE_KEM_CTRUARM
#include <oqs/kem_ctruarm.h>
#endif /* OQS_ENABLE_KEM_CTRUARM */

#ifdef OQS_ENABLE_KEM_CTRUREF
#include <oqs/kem_ctruref.h>
#endif /* OQS_ENABLE_KEM_CTRUREF */
