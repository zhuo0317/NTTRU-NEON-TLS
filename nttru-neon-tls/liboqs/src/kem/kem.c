...
OQS_API int OQS_KEM_alg_is_enabled(const char *method_name) {
	if (method_name == NULL) {
		return 0;
	}  else if (0 == strcasecmp(method_name, OQS_KEM_alg_nttru)) {
#ifdef OQS_ENABLE_KEM_nttru
		return 1;
#else
		return 0;
#endif
	}  else if (0 == strcasecmp(method_name, OQS_KEM_alg_nttruref_768)) {
#ifdef OQS_ENABLE_KEM_nttruref_768
		return 1;
#else
		return 0;
#endif
	}  else if (0 == strcasecmp(method_name, OQS_KEM_alg_ctruarm)) {
#ifdef OQS_ENABLE_KEM_ctruarm
		return 1;
#else
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_ctruref)) {
...
OQS_API OQS_KEM *OQS_KEM_new(const char *method_name) {
	...
	if (0 == strcasecmp(method_name, OQS_KEM_alg_ctruref)) {
#ifdef OQS_ENABLE_KEM_ctruref
		return OQS_KEM_ctruref_new();
#else
		return NULL;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_ctruarm)) {
#ifdef OQS_ENABLE_KEM_ctruarm
		return OQS_KEM_ctruarm_new();
#else
		return NULL;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_nttru)) {
#ifdef OQS_ENABLE_KEM_nttru
		return OQS_KEM_nttru_new();
#else
		return NULL;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_nttruref_768)) {
#ifdef OQS_ENABLE_KEM_nttruref_768
		return OQS_KEM_nttruref_768_new();
#else
		return NULL;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_bike_l1)) {
